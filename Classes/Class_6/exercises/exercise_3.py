...
print(get_city_year(1000, 2, 50, 1200))  # Output: 3
print(get_city_year(1000, 2, -50, 5000))  # Output: -1
print(get_city_year(1500, 5, 100, 5000))  # Output: 15
print(get_city_year(1500000, 2.5, 10000, 2000000))  # Output: 10
