# why we need list or some other sequence type? 
# 1. To store multiple values in a single variable, keep track of some prices for example 
# 2. To keep track of the order of the values, for example, the order of the students in a class
# 3. To store a collection of items, for example, a list of the names of the students in a class
